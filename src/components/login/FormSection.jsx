        ...
        <>
             <section className="flex justify-center items-center min-h-screen">
                <div className="w-[400px]">
                    ...
                    <form action="">
                        <input type="text" className="border -border-primary-700 -text-primary-700 py-[4px] px-[8px] w-full rounded-lg mb-[16px] text-[16px] font-regular" placeholder="username or email"/>
